...
function check(){
	...
	document.form1.action="${path}/noti_servlet/NOinsert.do";
	document.form1.submit();
}
function cancel(){
	location.href="${path}/noti_servlet/list.do";
}
</script>
<style type="text/css">
textarea{
...
<tr>
  ...
  <tr align="center">
    ...
    <span>
      <input type="button" value="확인" onclick="check()" class="button">
    </span>
	<span>
      <input type="button" value="취소" onclick="cancel()" class="button" style="margin-left: 25px;">
	</span>
</form>
</div>
