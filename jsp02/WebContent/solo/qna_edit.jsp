...
$(function(){
	$("#btnUpdate").click(function(){
		document.form1.action="${path}/qna_servlet/Qupdate.do";
		document.form1.submit();
	});
	$("#btnDelete").click(function(){
		if(confirm("삭제하시겠습니까?")){
			document.form1.action="${path}/qna_servlet/Qdelete.do";
			document.form1.submit();
		}
	});
});
...
<table border="1" width="60%">
	<tr>
		<td>작성자 </td>
		<td><input name="writer" id="writer" size="60" value="${dto.writer}"
				style="width: 500px; height: 16px;"></td>
	</tr>
	<tr>
		<td>제목 </td>
		<td><input name="subject" id="subject" size="60" value="${dto.subject}"
				style="width: 500px; height: 16px;"></td>
	</tr>
	<tr>
		<td colspan="2"><textarea rows="10" cols="100" name="content" id="content">
	...
	<tr>
	    ...
	    <input type="button" value="수정" id="btnUpdate" class="button">
